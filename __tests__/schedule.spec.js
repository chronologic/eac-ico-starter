...
describe('Schedule Library', function() {
  ...
  it('correctly computes callData', function() {
    const EXAMPLE_METHOD_SIGNATURE = '0x11a4c710';
    const EXAMPLE_ADDRESS = '0xe87529a6123a74320e13a6dabf3606630683c029';

    const EXPECTED_CALL_DATA = `${EXAMPLE_METHOD_SIGNATURE}000000000000000000000000${EXAMPLE_ADDRESS.slice(
      2
    )}`;
    ...
    schedule.callMethodParameterTypes = ['address'];
    schedule.callMethodParameterValues = [EXAMPLE_ADDRESS];
